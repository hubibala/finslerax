...
from finslerax.geometry import Euclidean, Randers, Sphere, TriangularMesh
...
plot_trajectory(
    ax, traj_rand, color="green", linewidth=3, label="Randers (Wind Optimized)"
)
plot_trajectory(
    ax,
    traj_mesh,
