...
from finslerax.utils.math import GRAD_EPS, WIND_STIFFNESS, causal_wind_scale, safe_norm
...
class DiscreteRanders(AsymmetricMetric):
    ...
    :class:`finslerax.geometry.zoo.Randers` and :func:`finslerax.utils.causal_wind_scale`.
    """
    ...
    def zermelo_data(self, x: jax.Array) -> tuple[jax.Array, jax.Array, jax.Array]:
        ...
        # finslerax.geometry.zoo.Randers.zermelo_data for the soft/raw rationale.
