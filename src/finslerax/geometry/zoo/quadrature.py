...
The discrete path solvers (:class:`~finslerax.solvers.AVBDSolver`,
:class:`~finslerax.solvers.GaussNewtonGeodesic`) score a segment ``[x_i, x_{i+1}]`` by
...
:class:`SegmentQuadratureMetric` wraps any :class:`~finslerax.geometry.metric.FinslerMetric`
...
class SegmentQuadratureMetric(FinslerMetric):
    ...
    Args:
        base: The wrapped :class:`~finslerax.geometry.metric.FinslerMetric`.  Its
