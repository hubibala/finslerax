"""
Finsler Metric base class — the core geometric abstraction of finslerax.
...
See Also:
    finslerax.geometry.zoo : Concrete metric implementations.
    finslerax.geometry.transport : Berwald parallel transport built on this class.
"""
