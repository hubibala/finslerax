...
learned metric classes in finslerax.models.learned.
...
class RandomFourierFeatures(eqx.Module):
    ...
    See also:
        finslerax.models.learned.NeuralRanders for typical usage.
    """
...
class VectorField(eqx.Module):
    ...
    See also:
        ...
        finslerax.models.learned.NeuralRanders — primary consumer.
    """
...
class PSDMatrixField(eqx.Module):
    ...
    See also:
        ...
        finslerax.utils.math.PSD_EPS — canonical epsilon constant.
    """
