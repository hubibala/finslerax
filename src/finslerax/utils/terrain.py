"""Terrain mesh utilities for finslerax.
...
from finslerax.models.covariate import project_b_norm, project_spd
...
class CovariateMeshRanders(AsymmetricMetric):
    ...
    :class:`~finslerax.models.covariate.CovariateConditionedRanders` but operates on
    ...
    (:meth:`~finslerax.geometry.mesh.TriangularMesh.get_face_weights`).  The
