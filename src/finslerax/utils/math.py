"""Canonical numerical stability primitives for finslerax.
...
from finslerax.utils.config import EpsKind as _EpsKind
from finslerax.utils.config import eps as _eps
...
# These floors scale with the working precision (see finslerax.utils.config.eps):
