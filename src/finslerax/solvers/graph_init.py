...
high-cost void, where every *local* solver (:class:`~finslerax.solvers.AVBDSolver` or
:class:`~finslerax.solvers.GaussNewtonGeodesic`) stalls, diverges, or — worse — finds a
...
split, expressed with finslerax's own geometry.
...
from finslerax.solvers.continuation import resample_path
