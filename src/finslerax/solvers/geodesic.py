...
__all__ = ["ExponentialMap", "GeodesicState"]
...
class ExponentialMap(eqx.Module):
    ...
    def _step_rk4(
        self, metric: FinslerMetric, state: GeodesicState, dt: float
    ) -> GeodesicState:
    ...
    def shoot(
        self, metric: FinslerMetric, x0: jax.Array, v0: jax.Array, t_max: float = 1.0
    ) -> jax.Array:
