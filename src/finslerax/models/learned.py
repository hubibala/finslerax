...
inherit from the Riemannian and Randers base classes in finslerax.geometry.zoo. These
...
class NeuralRanders(Randers):
    ...
    See also:
        finslerax.geometry.zoo.Randers, finslerax.nn.networks.VectorField,
        finslerax.nn.networks.PSDMatrixField, examples/demo_learned_wind.py.
    """
...
class PullbackRanders(Randers):
    ...
    See also:
        PullbackGNet, PullbackRiemannian.
    """
